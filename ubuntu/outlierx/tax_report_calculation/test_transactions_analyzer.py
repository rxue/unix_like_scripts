...
def test_stock_trading_profit_in_fifo_base():
    ...
    transactions = [
        Lot(date="2024-01-01", symbol="TEST", type="BUY", share_amount=10, total_amount=100.0),
        Lot(date="2024-01-02", symbol="TEST", type="SELL", share_amount=10, total_amount=150.0),
    ]
...
def test_stock_trading_profit_in_fifo_order():
    transactions = [
        Lot(date="2024-01-13", symbol="TEST", type="BUY", share_amount=20, total_amount=574.68),
        Lot(date="2024-01-13", symbol="TEST", type="BUY", share_amount=20, total_amount=575.96),
        Lot(date="2024-01-30", symbol="TEST", type="SELL", share_amount=20, total_amount=612),
    ]
...
def test_partial_sell_from_single_buy():
    ...
    transactions = [
        Lot(date="2024-01-01", symbol="TEST", type="BUY", share_amount=20, total_amount=200.0),
        Lot(date="2024-01-02", symbol="TEST", type="SELL", share_amount=10, total_amount=150.0),
    ]
    assert stock_trading_profit_in_fifo(transactions)[0] == 50.0
...
def test_sell_across_multiple_buys():
    ...
    transactions = [
        Lot(date="2024-01-01", symbol="TEST", type="BUY", share_amount=5, total_amount=50.0),
        Lot(date="2024-01-02", symbol="TEST", type="BUY", share_amount=10, total_amount=200.0),
        Lot(date="2024-01-03", symbol="TEST", type="SELL", share_amount=10, total_amount=250.0),
    ]
